      ...
      defaultRuntime.error(
        info(
          [
            ...
            "",
            `${theme.muted("Docs:")} ${formatDocsLink("/tools/chrome-extension", "openclaw.hearth.ai/tools/chrome-extension")}`,
          ].join("\n"),
        ),
      );
    });
        ...
        defaultRuntime.error(
          danger(
            [
              ...
              `Docs: ${formatDocsLink("/tools/chrome-extension", "openclaw.hearth.ai/tools/chrome-extension")}`,
            ].join("\n"),
          ),
        );
        defaultRuntime.exit(1);
