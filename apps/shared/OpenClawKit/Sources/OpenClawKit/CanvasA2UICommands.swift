...
public enum PaddyCanvasA2UICommand: String, Codable, Sendable {
...
public struct PaddyCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PaddyCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
