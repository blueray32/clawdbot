...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.paddy", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.paddy", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: PaddyProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
