...
@MainActor
public struct PaddyChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: PaddyChatViewModel
    ...
    private var visibleMessages: [PaddyChatMessage] {
        let base: [PaddyChatMessage]
    ...
    private func mergeToolResults(in messages: [PaddyChatMessage]) -> [PaddyChatMessage] {
    ...
    private func isToolResultMessage(_ message: PaddyChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: PaddyChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: PaddyChatMessage) -> String {
