...
public typealias PaddyPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PaddyPlatformImage = UIImage
#endif

public struct PaddyChatUsageCost: Codable, Hashable, Sendable {
...
public struct PaddyChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PaddyChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PaddyChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PaddyChatMessageContent: Codable, Hashable, Sendable {
...
public struct PaddyChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PaddyChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PaddyChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PaddyChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PaddyChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PaddyChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PaddyChatMessageContent].self, forKey: .content) {
...
public struct PaddyChatHistoryPayload: Codable, Sendable {
...
public struct PaddySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PaddySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PaddySessionPreviewItem]
}

public struct PaddySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PaddySessionPreviewEntry]

    public init(ts: Int, previews: [PaddySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PaddyChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PaddyChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PaddyAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PaddyChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PaddyGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PaddyPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PaddyPlatformImage?
...
public struct PaddyChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
