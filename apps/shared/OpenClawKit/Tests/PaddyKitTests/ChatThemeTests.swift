...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PaddyChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PaddyChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
