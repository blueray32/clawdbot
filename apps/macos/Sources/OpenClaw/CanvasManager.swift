...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.paddy", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Paddy/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__paddy__/a2ui/").absoluteString + "?platform=macos"
    }
