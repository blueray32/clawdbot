...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.paddy", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PaddyConfigFile.defaultWorkspaceURL() }
