...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PaddyConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PaddyConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = PaddyConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/paddy"
        state.remoteCliPath = ""
        return state
    }
}
