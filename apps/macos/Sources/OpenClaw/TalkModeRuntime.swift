...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.paddy", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.paddy", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PaddyChatMessage] = messages.compactMap { item in
