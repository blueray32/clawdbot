...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.paddy", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PaddyPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PaddyPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
