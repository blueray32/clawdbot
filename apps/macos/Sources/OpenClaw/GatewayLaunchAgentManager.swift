...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.paddy", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".paddy/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.paddyCommand(
            subcommand: "gateway",
