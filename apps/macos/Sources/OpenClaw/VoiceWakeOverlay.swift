...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.paddy", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Paddy windows, but below the system’s pop-up menus.
