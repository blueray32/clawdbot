...
enum UIStrings {
    static let welcomeTitle = "Welcome to Paddy"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: PaddyOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: PaddyChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g paddy@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: PaddyChatViewModel(
